...
public class JStep7 {
	...
	public static void run(Map<String, String> path) throws IOException, ClassNotFoundException, InterruptedException {
		...
		//---------------------读取正确率---------------------------
		Path pathCorrectRate = new Path("hdfs://192.168.126.130:9000/user/findTruth/JudgeMethod/step6");
		...
		Job job = new Job(JTruthMain.config(),"step7");
        ...
        job.setJarByClass(JStep7.class);
